...
Funcion PreguntaJavaScript(i Por Referencia, corr Por Referencia, inc Por Referencia, puntuacion Por Referencia) 
    ...
    Segun i Hacer
        Caso 1:
            ...
            FinSi
		Caso 2:
			Escribir "¿Cuál de las siguientes es una estructura de control en JavaScript?";
            Escribir "1. loop";
            Escribir "2. for";
            Escribir "3. repeat";
            Escribir "4. foreach";
        ...
        Caso 3:
            Escribir "¿Qué método se utiliza para agregar un elemento al final de un array en JavaScript?";
            Escribir "1. push";
            Escribir "2. add";
            Escribir "3. insert";
            Escribir "4. append";
